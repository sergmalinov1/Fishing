...
Shader "Custom/Water Reflective Bumped (Fog)" {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf Lambert alpha approxview alpha:blend
		#pragma target 3.0
		...
		void surf (Input IN, inout SurfaceOutput o) {
			...
			//  Fog
			half fogDepth = distance(_WorldSpaceCameraPos, mul((float3x3) unity_ObjectToWorld, IN.worldPos)) / _FogFactor;
