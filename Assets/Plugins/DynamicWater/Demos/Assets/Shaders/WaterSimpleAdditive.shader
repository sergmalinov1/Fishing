   ...
   Category {
         ...
         SubShader {
               ...
               Pass {
                  ...
                  inline fixed trianglePulse(half t, half a) {
                  ...
                  v2f vert (appdata_t v) {
                     ...
                     // Texture animation
                     o.texcoord1.z = trianglePulse(_Time.y, _TimeFactor);
                  ...
                  fixed4 frag (v2f i) : COLOR {
                     fixed4 texColor;
                     fixed wInverted = 1 - i.color.w;
                     texColor.xyz = tex2D(_MainTex, 1 - i.texcoord.xy).xyz * wInverted * i.texcoord1.z + 
                                    tex2D(_MainTex, i.texcoord.xy).xyz * wInverted * (1 - i.texcoord1.z) + 
