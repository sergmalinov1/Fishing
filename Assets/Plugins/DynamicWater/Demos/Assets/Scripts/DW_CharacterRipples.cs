...
public class DW_CharacterRipples : MonoBehaviour {
    ...
    protected void FixedUpdate() 
    {
        ...
        if (_waterDetector.Water != null) 
        {
           ...
           // Debug.Log($"_controller.bounds.center.y - " + _controller.bounds.center.y);
            // Debug.Log($"_isSubmerged - " + _isSubmerged);
           //  Debug.Log($"controller.velocity.sqrMagnitude  - " + _controller.velocity.sqrMagnitude);
            ...
            if (_splashAllowed && _isSubmerged && _isSubmerged != _isSubmergedPrev) 
            {
                Debug.Log("CHECK 222");
