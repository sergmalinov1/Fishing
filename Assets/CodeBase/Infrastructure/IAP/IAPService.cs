...
namespace CodeBase.Infrastructure.IAP
{
    public class IAPService : IIAPService
    {
        ...
        public bool IsInitialized =>
          _iapProvider.IsInitialize;

        public event Action Initialized;

        public IAPService(IAPProvider iapProvider, IPersistentProgress progressService)
        {
        ...
        public PurchaseProcessingResult ProcessPurchase(Product purchasedProduct)
        {
            ...
            {
                case ItemType.Skull:
                    _progressService.Progress.MoneyData.Add(productConfig.Quantity);
